  ...
  const services = [
    {
      ...
      title: "Bin Cleaning",
      description:
        "We attend once every 4 weeks for each bin rotation, cleaning your domestic and recycling bins",
      image: "/s1.jpg",
    ...
    },
    {
      ...
      description:
        "Using the latest guttering cleaning equipment we are able to clean your gutters from the safety of the ground",
      image: "/s2.jpg",
    ...
    },
    {
      ...
      description:
        "A high-powered pressure washer system and a 20-inch surface cleaner is used to remove dirt, surface growth, weeds and stains. ",
      image: "/s5.jpg",
          ...
          >
            ...
            <div className="mb-6 flex items-center justify-center w-full h-52 md:h-64 rounded-xl overflow-hidden group-hover:shadow-xl transition-all duration-300">
              <img
                src="/logo.png"
                alt={service.title}
                className="w-[50%] h-15 object-cover group-hover:scale-105 transition-transform duration-300"
              />
            </div>
