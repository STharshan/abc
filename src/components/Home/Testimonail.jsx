...
export default function TestimonialsSection() {
  const testimonials = [
    {
      name: "Kat Powis",
      text: `We've had ABC clean our bins for nearly 3 years now and have never had a problem. The bins have been brilliantly cleaned, always turn up regardless of the weather and are 100% reliable. You definitely get your moneys worth and with their social media presence, it's easy to understand their rotas, take part in competitions and be familiar with the staff`,
      rating: 5,
    },
    {
      name: "M Van Haute",
      text: `I've had my bins cleaned for several years now and these guys do an absolutely amazing job! Totally recommend!`,
      rating: 5,
    },
    {
      name: "Angela Randle",
      text: `We have been using ABC for our bin cleaning for the last 3 years. The lads are brilliant, kind, considerate. We pay annually 1, it's less expensive and 2 because we haven't got to worry about it. But they offer different methods from a 1 off or on a regular basis. Totally awesome, thank you`,
      rating: 5,
    },
  ];
